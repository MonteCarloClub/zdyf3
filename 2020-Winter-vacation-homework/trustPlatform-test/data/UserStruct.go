...
func NewUser(uid string, publicKey string, upk string,utype string) *User {
	return &User{ObjectType: constant.User, Uid: uid, PublicKey: publicKey, UPK: upk,UserType:utype}
}
